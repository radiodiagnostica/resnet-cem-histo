...
An optimal classification threshold of 0.829 was determined from the validation set based on maximizing the F1-score for the HR-negative class. @tbl:results presents the discrimination results with 95 % bootstrap confidence intervals for the training, validation, and independent-test sets, comparing performance using a standard 0.5 threshold and this optimal threshold.
